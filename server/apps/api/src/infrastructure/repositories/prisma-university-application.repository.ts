  ...
  async save(application: UniversityApplication): Promise<UniversityApplication> {
    ...
    const created = await (this.prisma as any).upward_university_application.upsert({
      ...
      create: {
        ...
        sessionTime: rawData.sessionTime ?? null,
        sourceIdentifier: rawData.sourceIdentifier ?? null,
      ...
      update: {
        ...
        scholarshipVideoUrl: rawData.scholarshipVideoUrl ?? null,
        sessionTime: rawData.sessionTime ?? null,
        sourceIdentifier: rawData.sourceIdentifier ?? undefined,
        abVariant: rawData.abVariant ? rawData.abVariant.toUpperCase() : undefined,
