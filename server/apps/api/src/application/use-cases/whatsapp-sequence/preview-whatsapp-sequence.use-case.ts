...
export interface PreviewWhatsappSequenceQuery {
  stage: string;
  firstName?: string;
}

@Injectable()
export class PreviewWhatsappSequenceUseCase {
  constructor(private readonly configService: ConfigService) {}

  async execute(query: PreviewWhatsappSequenceQuery): Promise<{ text: string }> {
