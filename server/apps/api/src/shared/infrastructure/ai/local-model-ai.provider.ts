...
import { IDocumentAiProvider, AiParseDocumentInput, AiParsedRow } from '../../../domains/pm/ai-document/ai-document.interface';
...
export class LocalModelAiProvider implements IDocumentAiProvider {
  ...
  async parseDocument(input: AiParseDocumentInput): Promise<AiParsedRow[]> {
    const localUrl = this.configService.get<string>('LOCAL_AI_URL', 'http://localhost:11434/api/generate');
