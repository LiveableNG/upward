    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} style={{ padding: '16px 0 0 0' }}>
        ...
        <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px dashed var(--border)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: rentType === 'Lease' ? '1fr 1fr 1fr' : '1fr 1fr', gap: 16, marginBottom: 16 }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
        ...
        <div className="glass" style={{ padding: 24, borderRadius: 16, background: 'var(--ivory-faint)', marginBottom: 32 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <input
              ...
              className="form-input"
              style={{ width: 76, height: CONTROL_HEIGHT, padding: '0 8px', textAlign: 'center', fontSize: 14, fontWeight: 600, boxSizing: 'border-box' }}
              min="1"
              max="30"
            />
