...
export const DataImportTab: React.FC = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const rows = mode === 'full' ? [
      ...
      ['Sapphire Heights', '45 Glover Road, Ikoyi', 'Residential', 'Nigeria', 'Lagos', 'Ikoyi', 'Bob', 'Property Group', 'bob@property.com', '+2348022223333', 'Sarah', 'Smith', 'sarah@tenant.com', '+2348044445555', 'Suite 2A', '3500000', '3500000', 'Annually', 'NGN', '2024-02-01', '2025-02-01', '350000', 'Premium suite'],
      ['Ruby Terraces', '88 Isaac John St, Ikeja', 'Residential', 'Nigeria', 'Lagos', 'Ikeja GRA', 'Charlie', 'Ventures', 'charlie@ventures.com', '+2348033334444', 'Michael', 'Brown', 'michael@tenant.com', '+2348055556666', 'Flat 3', '1800000', '1800000', 'Annually', 'NGN', '2024-03-01', '2025-03-01', '180000', 'Refurbished unit'],
      ['Diamond Plaza', '15 Broad Street, Marina', 'Commercial', 'Nigeria', 'Lagos', 'Lagos Island', 'David', 'Holdings', 'david@holdings.com', '+2348044445555', 'Emily', 'Davis', 'emily@tenant.com', '+2348066667777', 'Office 405', '5000000', '0', 'Annually', 'NGN', '2024-04-01', '2025-04-01', '500000', 'Corporate office'],
      ['Topaz Villas', '10 Gwarinpa Estate, Abuja', 'Residential', 'Nigeria', 'Abuja', 'Gwarinpa', 'Eve', 'Estates', 'eve@estates.com', '+2348055556666', 'William', 'Wilson', 'william@tenant.com', '+2348077778888', 'Villa B', '4000000', '4000000', 'Annually', 'NGN', '2024-05-01', '2025-05-01', '400000', 'Luxury villa'],
      ['Pearl Apartments', '22 Trans Amadi, Port Harcourt', 'Residential', 'Nigeria', 'Rivers', 'Trans Amadi', 'Frank', 'Realty', 'frank@realty.com', '+2348066667777', 'Olivia', 'Taylor', 'olivia@tenant.com', '+2348088889999', 'Room 12', '1200000', '600000', 'Annually', 'NGN', '2024-06-01', '2025-06-01', '120000', 'Shared space'],
      ['Onyx Towers', '5 Eko Atlantic, VI', 'Commercial', 'Nigeria', 'Lagos', 'Victoria Island', 'Grace', 'Properties', 'grace@props.com', '+2348077778888', 'James', 'Anderson', 'james@tenant.com', '+2348099990000', 'Unit 701', '8000000', '8000000', 'Annually', 'NGN', '2024-07-01', '2025-07-01', '800000', 'High rise office'],
      ['Amber Gardens', '14 Ring Road, Ibadan', 'Residential', 'Nigeria', 'Oyo', 'Ibadan North', 'Henry', 'Trust', 'henry@trust.com', '+2348088889999', 'Sophia', 'Thomas', 'sophia@tenant.com', '+2348011113333', 'Block A1', '900000', '900000', 'Annually', 'NGN', '2024-08-01', '2025-08-01', '90000', 'Suburban living'],
      ['Quartz Mall', '33 Independence Ave, Enugu', 'Commercial', 'Nigeria', 'Enugu', 'Enugu South', 'Ivy', 'Invest', 'ivy@invest.com', '+2348099990000', 'Robert', 'Jackson', 'robert@tenant.com', '+2348022224444', 'Shop G12', '3000000', '1500000', 'Annually', 'NGN', '2024-09-01', '2025-09-01', '300000', 'Retail outlet'],
      ['Jade Complex', '77 Yakubu Gowon Way, Jos', 'Residential', 'Nigeria', 'Plateau', 'Jos North', 'Jack', 'Homes', 'jack@homes.com', '+2348011110000', 'Isabella', 'White', 'isabella@tenant.com', '+2348033335555', 'Unit 4', '1500000', '1500000', 'Annually', 'NGN', '2024-10-01', '2025-10-01', '150000', 'Hillside view'],
      ['Coral Reef', '2 Banana Island, Ikoyi', 'Residential', 'Nigeria', 'Lagos', 'Ikoyi', 'Kate', 'Luxury', 'kate@luxury.com', '+2348022221111', 'Thomas', 'Harris', 'thomas@tenant.com', '+2348044446666', 'Penthouse', '15000000', '15000000', 'Annually', 'NGN', '2024-11-01', '2025-11-01', '1500000', 'Waterfront view'],
      ['Silver Plaza', '50 Allen Ave, Ikeja', 'Commercial', 'Nigeria', 'Lagos', 'Ikeja', 'Leo', 'Global', 'leo@global.com', '+2348033332222', 'Mia', 'Martin', 'mia@tenant.com', '+2348055557777', 'Store 5', '2000000', '0', 'Annually', 'NGN', '2024-12-01', '2025-12-01', '200000', 'Busy location'],
      ['Golden Gate', '19 Ahmadu Bello Way, Kaduna', 'Residential', 'Nigeria', 'Kaduna', 'Kaduna North', 'Mark', 'Realty', 'mark@realty.ng', '+2348044443333', 'Samuel', 'Garcia', 'samuel@tenant.com', '+2348066668888', 'Flat 202', '1000000', '1000000', 'Annually', 'NGN', '2024-01-15', '2025-01-15', '100000', 'Quiet area'],
      ['Copper Springs', '9 Trans-Ekulu, Enugu', 'Residential', 'Nigeria', 'Enugu', 'Trans-Ekulu', 'Nora', 'Estates', 'nora@estates.ng', '+2348055554444', 'Amelia', 'Martinez', 'amelia@tenant.com', '+2348077779999', 'Unit 8', '1100000', '1100000', 'Annually', 'NGN', '2024-02-15', '2025-02-15', '110000', 'Family home'],
      ['Iron Gate', '12 Onitsha Road, Owerri', 'Commercial', 'Nigeria', 'Imo', 'Owerri Municipal', 'Paul', 'Developments', 'paul@dev.com', '+2348066665555', 'Ethan', 'Robinson', 'ethan@tenant.com', '+2348088880000', 'Warehouse A', '6000000', '6000000', 'Annually', 'NGN', '2024-03-15', '2025-03-15', '600000', 'Large storage'],
      ['Stone Arch', '6 Warri Sapele Rd, Warri', 'Residential', 'Nigeria', 'Delta', 'Warri South', 'Rose', 'Holdings', 'rose@holdings.com', '+2348077776666', 'Charlotte', 'Clark', 'charlotte@tenant.com', '+2348099991111', 'Flat 1A', '800000', '400000', 'Annually', 'NGN', '2024-04-15', '2025-04-15', '80000', 'Compact living'],
      ['Marble Palace', '3 Maitama District, Abuja', 'Residential', 'Nigeria', 'Abuja', 'Maitama', 'Steve', 'Premier', 'steve@premier.com', '+2348088887777', 'Daniel', 'Rodriguez', 'daniel@tenant.com', '+2348011112222', 'Suite 10', '12000000', '12000000', 'Annually', 'NGN', '2024-05-15', '2025-05-15', '1200000', 'Exclusive area'],
      ['Granite House', '44 Bode Thomas, Surulere', 'Commercial', 'Nigeria', 'Lagos', 'Surulere', 'Tina', 'Investments', 'tina@invest.com', '+2348099998888', 'Harper', 'Lewis', 'harper@tenant.com', '+2348022223333', 'Office 2', '2500000', '2500000', 'Annually', 'NGN', '2024-06-15', '2025-06-15', '250000', 'Central location'],
      ['Clayton Court', '21 Calabar Road, Calabar', 'Residential', 'Nigeria', 'Cross River', 'Calabar South', 'Umar', 'Homes', 'umar@homes.com', '+2348011119999', 'Evelyn', 'Lee', 'evelyn@tenant.com', '+2348033334444', 'Unit 15', '750000', '750000', 'Annually', 'NGN', '2024-07-15', '2025-07-15', '75000', 'Budget friendly'],
      ['Bronze Villa', '11 Airport Road, Benin', 'Residential', 'Nigeria', 'Edo', 'Oredo', 'Vera', 'Villas', 'vera@villas.com', '+2348022220000', 'Abigail', 'Walker', 'abigail@tenant.com', '+2348044445555', 'Villa 5', '2800000', '2800000', 'Annually', 'NGN', '2024-08-15', '2025-08-15', '280000', 'Gated community'],
    ] : [
      ['101', 'John', 'Doe', 'john@example.com', '+2348012345678', '2000000', '2000000', '2024-01-01', '2024-05-01', 'Monthly', '200000', 'NGN', 'Imported memo'],
      ['102', 'Jane', 'Smith', 'jane@example.com', '+2348023456789', '2500000', '2500000', '2024-02-01', '2025-02-01', 'Annually', '250000', 'NGN', 'Top floor'],
      ['103', 'Michael', 'Johnson', 'mike@example.com', '+2348034567890', '1800000', '0', '2024-03-01', '2025-03-01', 'Annually', '180000', 'NGN', 'Needs painting'],
      ['201', 'Emily', 'Brown', 'emily@example.com', '+2348045678901', '3000000', '3000000', '2024-04-01', '2025-04-01', 'Annually', '300000', 'NGN', 'Spacious unit'],
      ['202', 'William', 'Jones', 'will@example.com', '+2348056789012', '1200000', '600000', '2024-05-01', '2024-11-01', 'Monthly', '120000', 'NGN', 'New tenant'],
      ['301', 'Olivia', 'Garcia', 'olivia@example.com', '+2348067890123', '2200000', '2200000', '2024-06-01', '2025-06-01', 'Annually', '220000', 'NGN', 'Renovated'],
      ['302', 'James', 'Miller', 'james@example.com', '+2348078901234', '1500000', '1500000', '2024-07-01', '2025-07-01', 'Annually', '150000', 'NGN', 'Standard unit'],
      ['401', 'Sophia', 'Davis', 'sophia@example.com', '+2348089012345', '4500000', '4500000', '2024-08-01', '2025-08-01', 'Annually', '450000', 'NGN', 'Executive floor'],
      ['402', 'Robert', 'Rodriguez', 'rob@example.com', '+2348090123456', '900000', '900000', '2024-09-01', '2024-12-01', 'Monthly', '90000', 'NGN', 'Small studio'],
      ['501', 'Isabella', 'Martinez', 'isabella@example.com', '+2348011122233', '2800000', '2800000', '2024-10-01', '2025-10-01', 'Annually', '280000', 'NGN', 'Corner unit'],
      ['502', 'Thomas', 'Hernandez', 'tom@example.com', '+2348022233344', '1100000', '0', '2024-11-01', '2025-11-01', 'Annually', '110000', 'NGN', 'Pending deposit'],
      ['601', 'Mia', 'Lopez', 'mia@example.com', '+2348033344455', '3200000', '3200000', '2024-12-01', '2025-12-01', 'Annually', '320000', 'NGN', 'Modern finishes'],
      ['602', 'Samuel', 'Gonzalez', 'sam@example.com', '+2348044455566', '1400000', '1400000', '2024-01-15', '2025-01-15', 'Annually', '140000', 'NGN', 'Quiet side'],
      ['701', 'Amelia', 'Wilson', 'amelia@example.com', '+2348055566677', '2100000', '2100000', '2024-02-15', '2025-02-15', 'Annually', '210000', 'NGN', 'Bright unit'],
      ['702', 'Ethan', 'Anderson', 'ethan@example.com', '+2348066677788', '1900000', '1900000', '2024-03-15', '2025-03-15', 'Annually', '190000', 'NGN', 'Recently vacated'],
      ['801', 'Charlotte', 'Thomas', 'charlotte@example.com', '+2348077788899', '2600000', '2600000', '2024-04-15', '2025-04-15', 'Annually', '260000', 'NGN', 'Garden view'],
      ['802', 'Daniel', 'Taylor', 'dan@example.com', '+2348088899900', '1300000', '0', '2024-05-15', '2025-05-15', 'Annually', '130000', 'NGN', 'Standard layout'],
      ['901', 'Harper', 'Moore', 'harper@example.com', '+2348099900011', '3800000', '3800000', '2024-06-15', '2025-06-15', 'Annually', '380000', 'NGN', 'Luxury suite'],
      ['902', 'Evelyn', 'Jackson', 'evelyn@example.com', '+2348011122244', '1000000', '1000000', '2024-07-15', '2024-10-15', 'Monthly', '100000', 'NGN', 'Cozy studio'],
      ['1001', 'Abigail', 'Martin', 'abigail@example.com', '+2348022233355', '2400000', '2400000', '2024-08-15', '2025-08-15', 'Annually', '240000', 'NGN', 'Well maintained'],
    ]
