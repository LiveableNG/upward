            ...
            <div key={idx} className={cn('mapping-card', 
              ...
              <div className="mapping-card__header">
                <div className="mapping-card__title">
                  ...
                  {isDuplicate && (
                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 12, color: 'var(--error)', background: 'var(--error-bg)', padding: '2px 8px', borderRadius: 12, fontWeight: 600 }}>
