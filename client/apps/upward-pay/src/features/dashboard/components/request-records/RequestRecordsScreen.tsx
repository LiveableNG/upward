...
import { ArrowLeft, Clock, Plus, MapPin, Building, Phone, Mail, User, ShieldCheck, HelpCircle, CheckCircle, FileText, ChevronRight, TrendingUp, Calendar } from 'lucide-react'
...
export function RequestRecordsScreen() {
  ...
  const { user } = useAuth()
  const [useProfileProperty, setUseProfileProperty] = useState(true)
  ...
  return (
    <div className="req-records dashboard--nav-offset">
          ...
          <div className="req-form animate-fade-in">
            ...
            <div className="req-empty-state">
              ...
              <button 
                ...
                onClick={() => router.push('/dashboard/me?view=personal&edit=true')}
              >
                Add Your Property
              </button>
            </div>
                      ...
                      >
                        <td>
                          <div className="flex items-center gap-2">
                           ...
                           <div className="flex flex-col">
                             ...
                             <span className="text-xs text-muted">{req.propertyAddress}</span>
                           </div>
                          </div>
                        </td>
                        ...
                        <td>
                          {req.status === 'COMPLETED' ? (
                            <span className="text-green">+ Score Boost</span>
                          ) : (
                            <span className="text-muted">Pending Impact</span>
                          )}
                        </td>
                      </tr>
      ...
      <style jsx>{`
        ...
        .req-history__loading, .req-history__empty {
          display: flex;
        ...
        .req-history__loading p, .req-history__empty p { margin-top: 1rem; font-weight: 600; }
        .spinner {
          width: 32px;
          height: 32px;
        ...
        .req-banner__content h3 {
          font-size: 1.1rem;
          font-weight: 800;
          color: var(--clay);
          margin: 0 0 0.25rem;
        }
        .req-banner__content p {
          font-size: 0.85rem;
          line-height: 1.5;
          color: var(--text-muted);
          margin: 0;
        ...
        .req-empty-state {
          ...
          background: rgba(var(--clay-rgb), 0.05);
          border: 1px dashed rgba(var(--clay-rgb), 0.3);
          border-radius: 16px;
        }
        ...
        .prop-card.selected .prop-card__icon {
          background: var(--clay);
          color: white;
          border-color: var(--clay);
        }
        ...
        .prop-card__info strong {
          font-size: 0.95rem;
          font-weight: 700;
        }
        .prop-card__info span {
          font-size: 0.8rem;
          color: var(--text-muted);
        }
        .prop-card__radio {
        ...
        .prop-card.selected .prop-card__radio {
          border-color: var(--clay);
        }
        .prop-card.selected .radio-inner {
          width: 10px;
          height: 10px;
          background: var(--clay);
          border-radius: 50%;
        ...
        .req-history__info strong {
          font-size: 0.95rem;
          font-weight: 700;
        }

        .req-history__info span {
          font-size: 0.75rem;
          color: var(--text-muted);
          margin-top: 2px;
        }
        ...
        .req-history__status--pending {
          background: rgba(var(--warning-rgb, 245, 158, 11), 0.1);
          color: var(--warning);
        }

        .req-history__status--completed {
          background: rgba(var(--success-rgb, 16, 185, 129), 0.1);
          color: var(--success);
        }
        ...
        .req-history__table td:first-child {
          min-width: 220px;
          white-space: nowrap;
        }
        ...
        @media (min-width: 768px) {
          ...
          .req-history__table { display: table; }
          .req-history { padding: 2.5rem; }
        }
        ...
        .record-mini-info .date {
          font-size: 11px;
          font-weight: 700;
          color: var(--text-muted);
        }
        .record-mini-info .amount {
          font-size: 13px;
          font-weight: 800;
          color: var(--text);
        }
        ...
        .record-mini-badge.on-time {
          background: rgba(34, 197, 94, 0.1);
          color: var(--success);
        }
        .record-mini-badge.late {
