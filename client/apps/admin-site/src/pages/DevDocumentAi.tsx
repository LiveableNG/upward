      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div>
          <h1 className="section-title" style={{ margin: 0, fontSize: '20px' }}>
            AI Document Parser Sandbox
          </h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '13px', margin: '2px 0 0 0' }}>
            Upload files or paste raw unstructured rent rolls to test our multi-modal AI parser and
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, padding: '6px 0' }}>
            <p style={{ fontSize: 13, color: 'var(--text-secondary)', margin: 0, lineHeight: 1.5 }}>
              Choose how you want to process this document. We recommend using our AI parsing system
              for fast field extraction.
            </p>
            ...
            >
              ...
              <div>
                <strong
                  style={{ fontSize: 14, color: 'var(--dark)', display: 'block', marginBottom: 2 }}
                >
                  AI Auto-Onboarding{' '}
                  <span
                    style={{
                ...
                >
                  Auto-extracts properties, units, and tenants instantly. Drops data directly to the
                  review table.
                </span>
              </div>
            </button>
            ...
            {pendingFile.file.name.match(/\.(xlsx|xls|csv|xlsm|xlsb)$/i) ? (
              ...
              >
                ...
                <div>
                  ...
                  >
                    Only Excel and CSV spreadsheets support manual field-mapping. Choose AI for
                    other file types.
                  </span>
                </div>
              </button>
      ...
      {importState.isAiParsing && (
        ...
        >
          ...
          >
            ...
            />
            <h3 style={{ fontSize: 15, fontWeight: 700, color: 'var(--dark)', marginBottom: 8 }}>
              Analyzing layout & mapping fields...
            </h3>
            <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5, margin: 0 }}>
              Upward AI is parsing the document to extract properties, unit configurations, and
              tenant details. This will take a few seconds...
            </p>
          </div>
        </Modal>
      )}
