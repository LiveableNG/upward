    ...
    >
      ...
      >
        <div className="section-label" style={{ marginBottom: '24px', display: 'inline-block' }}>
          Privacy Control (Property Manager)
        </div>
        ...
        {status === 'success' ? (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            ...
            >
              We&apos;ve received your request to delete PM data associated with <strong>{email}</strong>. 
          ...
          <>
            ...
            >
              We value your privacy. If you wish to remove your Property Manager account, properties, and all associated data from our systems, 
            ...
            <form onSubmit={handleSubmit} style={{ textAlign: 'left' }}>
              ...
              >
                ...
                <p style={{ fontSize: '13px', color: 'var(--text)', lineHeight: 1.5 }}>
                  ...
                  permanent deletion of my Property Management Dashboard, properties, tenants history, and all account data.
                </p>
              </div>
...
export default function DeletePmPage() {
  return (
    <>
      {/* Background Glows */}
      <div
